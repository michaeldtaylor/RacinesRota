...
**Run the tests before and after.** `Invoke-Pester .\tests -Output Normal` — 136 tests, about
...
times out. `.\Invoke-Rota.ps1 -NoExcel` should finish in about 8 seconds with score 2280, zero
