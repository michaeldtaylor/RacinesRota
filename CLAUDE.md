...
**Run the tests before and after.** `Invoke-Pester .\tests -Output Normal` — 129 tests, about
20 seconds. Add `-ExcludeTagFilter Slow` to skip the ones that solve the real roster.
...
times out. `.\Invoke-Rota.ps1 -NoExcel` should finish in about 8 seconds with score 2732, zero
